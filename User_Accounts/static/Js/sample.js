const quizData = {
    questions: [
      {
        ...
        answer: "2",
        explanation:
          "Correct answer is B. A budget is planned to ensure that there's a plan for spending in the future, helping to manage finances effectively.",
        isAttempted: "0",
      },
      {
        ...
        answer: "2",
        explanation:
          "Correct answer is B. APR stands for Annual Percentage Rate, which measures the cost of credit per year.",
        isAttempted: "0",
      },
      {
        ...
        answer: "3",
        explanation:
          "Correct answer is C. A savings account is considered a liquid asset because the funds are readily accessible.",
        isAttempted: "0",
      },
      {
        ...
        answer: "2",
        explanation:
          "Correct answer is B. Diversification spreads risk across different assets, reducing the impact of a poor performance by any single investment.",
        isAttempted: "0",
      },
      {
        ...
        answer: "3",
        explanation:
          "Correct answer is C. Credit card debt is a liability because it's an obligation to pay money to another party.",
        isAttempted: "0",
      },
      {
        ...
        answer: "2",
        explanation:
          "Correct answer is B. It's advisable to have an emergency fund that covers at least three months' expenses for financial security.",
        isAttempted: "0",
      },
      {
        question:
          "Which of the following retirement accounts offers tax advantages for contributions?",
        options: [
          "Traditional IRA",
          "Savings account",
          "Checking account",
        ...
        answer: "1",
        explanation:
          "Correct answer is A. A Traditional IRA offers tax advantages, including tax-deductible contributions for qualified individuals.",
        isAttempted: "0",
      },
      {
        ...
        answer: "2",
        explanation:
          "Correct answer is B. Insurance transfers the financial risk from the insured to the insurer, providing financial protection against unforeseen events.",
        isAttempted: "0",
      },
      {
        question:
          "What is the correct order of steps in the financial planning process?",
        options: [
        ...
        answer: "1",
        explanation:
          "Correct answer is A. The first step in financial planning is setting goals, followed by creating a budget, saving and investing, and then reviewing and revising the plan.",
        isAttempted: "0",
      },
      {
        ...
        answer: "2",
        explanation:
          "Correct answer is B. Compound interest is calculated on both the initial principal and the accumulated interest, leading to exponential growth over time.",
        isAttempted: "0",
      },
      {
        ...
        answer: "1",
        explanation:
          "Correct answer is A. ROI stands for Return on Investment, which measures the efficiency of an investment.",
        isAttempted: "0",
      },
      {
        ...
        answer: "2",
        explanation:
          "Correct answer is B. A FICO score measures creditworthiness, indicating how likely individuals are to repay borrowed money.",
        isAttempted: "0",
      },
      {
        ...
        answer: "3",
        explanation:
          "Correct answer is C. Medical expenses can be tax-deductible if they exceed a certain portion of the taxpayer's adjusted gross income.",
        isAttempted: "0",
      },
      {
        ...
        answer: "3",
        explanation:
          "Correct answer is C. ETF stands for Exchange-Traded Fund, which is a type of investment fund that is traded on stock exchanges.",
        isAttempted: "0",
      },
      {
        ...
        answer: "1",
        explanation:
          "Correct answer is A. A will is used to distribute someone's assets after their death according to their wishes.",
        isAttempted: "0",
      },
    ],
  };
  ...
  // Example usage:
  runTimer(document.querySelector(".timer"), 2);
  ...
  function nextQuestion() {
    ...
    stopTimer();
    runTimer(document.querySelector(".timer"), 5);
